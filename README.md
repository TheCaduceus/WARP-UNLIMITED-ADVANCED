...
<h4><b>2.Now first open the WRAP+ Unlimited Script code and paste it in notepad and save it as "warp.py" don't forget to type ".py":<a href="https://github.com/TheCaduceus/WRAP-UNLIMITED-ADVANCED/blob/View-Script/Warp.md"> Show Code</a></b></h4>
